function lgraph = QRTCNNet(numFilters,filterSize,dropoutFactor,numBlocks,numFeatures,outputFeatures,alpha)
    ...
    layers = [
        ...
        quanRegressionLayer('quanRegLayer', alpha)];   % quantile regression layer
